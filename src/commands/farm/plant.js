...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const availableSlots = profile.maxSlots - profile.activeGarden.length;
            if (availableSlots <= 0) {
                return interaction.editReply({ content: "Your garden is completely full! Wait for plants to grow or upgrade your capacity in the shop." });
            }

            const amountToPlant = Math.min(requestedAmount, seedCount, availableSlots);
